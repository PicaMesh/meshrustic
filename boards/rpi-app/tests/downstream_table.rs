...
fn downstream_relay_picks_lowest_cost() {
    ...
    graph
        .downstream_mut()
        .update(0xAA00_00AA, 0xDD00_00DD, 0xBB00_00BB, 4.0, 1_000, false, 0);
    graph
        .downstream_mut()
...
fn downstream_relay_skips_stale_ttl() {
    ...
    graph
        .downstream_mut()
        .update(0xAA00_00AA, 0xDD00_00DD, 0xBB00_00BB, 2.0, 1_000, false, 0);
    graph
        .downstream_mut()
...
fn transfer_downstream_moves_entries() {
    ...
    graph
        .downstream_mut()
        .update(0xAA00_00AA, 0xD100_0001, 0x0100_0001, 2.0, 1_000, false, 0);
    graph
        .downstream_mut()
        .update(0xAA00_00AA, 0xD200_0002, 0x0100_0001, 3.0, 1_000, false, 0);
    assert_eq!(
        graph.transfer_downstream(0x0100_0001, 0x0200_0002, 2_000),
        2
    );
