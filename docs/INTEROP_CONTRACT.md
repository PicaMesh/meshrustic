...
- Per source node and 90 s window: TEXT 30, ROUTING 10, OTHER 4, UNKNOWN 12; packets addressed to
  ...
  (1.6% of a 24 h capture; busiest hour minted 79 identities) and far below flood volume.
  Thirty minutes is a commitment for an attacker at almost no cost to the mesh — not a knob to
